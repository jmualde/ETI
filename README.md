...
Cuando se descomprime queda una carpeta llamada ETI, esta misma la movemos a htdocs en caso de estar en Windows. En caso de estar con linux hay que entrar a var/www/HTML.
